...
public class GitHubServiceImpl implements GitHubService {
                ...
                return userRepository
                                ...
                                .orElseGet(
                                                () -> {
                                                        ...
                                                        newUser.setTeams(Arrays.asList("Classmates", "Friends",
                                                                        "Colleagues"));
                                                        ...
                                                        techAnalysis = repoService
                                                                        .getTechnicalProfile(githubUser.getUserName());
        ...
        public User findUser(String Username) {
                ...
                return userData.orElseGet(() -> getUser(Username));
        }

        /**
         * Parses a GitHub user map and populates a User object with basic information.
         * Does not include
         * repository details or technical profile.
         *
        ...
        private User parseUserFromMap(Map<String, Object> gitHubUser) {
                ...
                user.setFollowersCount(
                                MapUtils.extractIntFromNestedMap(gitHubUser, "followers", "totalCount", 0));
                user.setFollowingCount(
                                MapUtils.extractIntFromNestedMap(gitHubUser, "following", "totalCount", 0));
                user.setPublicReposCount(
                                MapUtils.extractIntFromNestedMap(gitHubUser, "repositories", "totalCount", 0));
                        ...
                        if (response != null && response.get("user") instanceof Map) {
                                ...
                                if (gitHubUser.get("repositories") instanceof Map) {
                                        ...
                                        if (repositories.get("nodes") instanceof List) {
                                                List<Map<String, Object>> repoNodes = (List<Map<String, Object>>) repositories
                                                                .get("nodes");
                                                for (Map<String, Object> map : repoNodes) {
                                                        ...
                                                        if (map.get("primaryLanguage") instanceof Map) {
                                                                Map<String, Object> primaryLang = (Map<String, Object>) map
                                                                                .get("primaryLanguage");
                                                        ...
                                                        repo.setStargazerCount(
                                                                        ((Integer) map.get("stargazerCount"))
                                                                                        .intValue());
                                ...
                                if (gitHubUser.get("contributionsCollection") instanceof Map) {
                                        ...
                                        if (contributionsCollection != null
                                                        && contributionsCollection
                                                                        .get("contributionCalendar") instanceof Map) {
                                                Map<String, Object> map = (Map<String, Object>) contributionsCollection
                                                                .get("contributionCalendar");
                                                int totalContributions = ((Integer) map.get("totalContributions"))
                                                                .intValue();
        ...
        public List<String> getTeams() {
                ...
                log.debug("Getting authenticated user: {}", authenticatedUser);
