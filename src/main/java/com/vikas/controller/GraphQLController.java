...
//
// public GraphQLController(GitHubService gitHubService, SuggestedUserService
// suggestedUserService) {
...
//
// @QueryMapping
// public List<GithubUser> users(@Argument Integer limit, @Argument Integer
// offset) {
// return List.of();
// }
//
// @QueryMapping
// public List<GithubUser> searchUsers(@Argument String query, @Argument Integer
// limit, @Argument Integer offset) {
// return gitHubService.searchUsers(query, limit != null ? limit : 10, offset !=
// null ? offset : 0);
// }
//
// // @QueryMapping
...
//
// @MutationMapping
// public SuggestedUser suggestUser(@Argument String githubUsername, @Argument
// String suggestedBy) {
